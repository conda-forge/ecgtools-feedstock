...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ecgtools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13907&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ecgtools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ecgtools` can be installed with:

```
conda install ecgtools
```

It is possible to list all of the versions of `ecgtools` available on your platform with:
